            ...
            <div class="card-box">
                ...
                <div class="breadcrumb">
                    <a href="{{route('admin.main')}}" class="header-title m-t-0 m-b-30"><i class="icon-home2 mr-2"></i>
                        الرئيسية</a> /
                    <a href="{{route('admin.branches.index')}}" class="header-title m-t-0 m-b-30"><i
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="header-title m-t-0 m-b-30"> اضافة فرع</h4>
                            {!!Form::open( ['route' => 'admin.branches.store', 'method' => 'Post','role'=>'form','class'=>'form-horizontal','files'=>true]) !!}
...
@push('scripts')
    <script>
        ...
        function initMap() {
            ...
            var uluru = {lat: 21.4025178, lng: 39.8533598};
