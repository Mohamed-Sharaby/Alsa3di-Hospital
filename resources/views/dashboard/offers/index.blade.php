                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <a href="{{route('admin.offers.create')}}"
                               class="btn btn-purple btn-rounded w-md waves-effect waves-light m-b-5">اضافة عرض
                                جديد</a>
                            <br>
                            <br>
                                ...
                                @foreach($items as $index => $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form
                                                action="{{ route('admin.active', ['id' => $item->id, 'type' => 'Offer']) }}"
                                            ...
                                            <button data-url="{{route('admin.offers.destroy',$item->id)}}"
                                                    data-name="{{ $item->name }}"
