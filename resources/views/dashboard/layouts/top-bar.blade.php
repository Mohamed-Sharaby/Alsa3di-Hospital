    ...
    <div class="navbar navbar-default mb-2" role="navigation" style="background-color: #426e96!important;color: white!important;">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li>
                    <h4 class="page-title" style="color: white!important;">   مستشفى الصاعدى - لوحة تحكم الادارة</h4>
                </li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="  ">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left">
                        <li><a href="{{route('admin.admins.edit',auth('admin')->id())}}"><i class="zmdi zmdi-settings m-r-5"></i> اعدادات الحساب</a></li>
